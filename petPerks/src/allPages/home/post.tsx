    ...
    return (
        <div className="flex flex-col pb-[126px] relative">
            ...
            <Carousel
                ...
                centerMode={true}
            >
                <div className="bg-[#FFFBFA] rounded-[30px] w-[390px] p-[30px] pb-[50px] relative">
                    ...
                    <h4 className="text-[#000] font-[lufga500] text-[20px] mb-[20px]">Uncovering the Beauty Benefits of Plant-Based Skincare</h4>
