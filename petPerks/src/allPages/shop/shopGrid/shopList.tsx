...
const ShopList = () => {
    ...
    return (
        <div className="flex flex-col gap-[50px] mx-auto">
            {
                dogs.map((value) => {
                    return <div className='flex flex-col relative petfoods' >

                        <div className="heart_div absolute left-4 bottom-4 heart cursor-pointer">
                            ...
                            <div className="py-[31px] w-[100%]">
                                <div className="flex justify-between w-[100%] mb-[19px]">
                                    <div className="flex flex-col">
                                        <h2 className="text-[20px] font-[lufga500] capitalize mb-[6px]">{value.menu.title}</h2>
                                        <p className="text-[14px] capitalize font-[lufga400]">{value.menu.what}</p>
                                    </div>
                                    <div className="flex flex-col">
                                        <Stack spacing={1}>
                                            <Rating name="half-rating" defaultValue={2.5} precision={0.5} />
                                        </Stack>
                                        <p className="text-[13px] text-[#5E626F]">370 Review</p>
                                    </div>
                                </div>
                                <p className="text-[15px] font-[lufga500] mb-[21.5px]">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</p>
                                <div className="flex justify-between">
                                    <div className="flex flex-col">
                                        <p className="mb-[9px] text-[#5E626F] text-[14px] capitalize">Price</p>
                                        <p className="text-[20px] font-[lufga500] capitalize">{value.menu.cost}.00</p>
                                    </div>
                                    <div className="flex items-center">
                                        <button className="mr-[10px] py-[12px] px-[25px] rounded-[10px] border-none bg-[#000] text-[#fff] text-[16px] capitalize hover:opacity-55">Add To Cart</button>
                                        <div className="p-[12px] border-[1px] rounded-[10px]">
